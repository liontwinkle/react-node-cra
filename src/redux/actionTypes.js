export default {
  ...
  // Update category
  PROPERTYFIELD_UPDATE_REQUEST: 'CATEGORY_UPDATE_REQUEST',
  PROPERTYFIELD_UPDATE_SUCCESS: 'CATEGORY_UPDATE_SUCCESS',
  PROPERTYFIELD_UPDATE_FAIL: 'CATEGORY_UPDATE_FAIL',
};
